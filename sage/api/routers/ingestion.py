    ...
    responses={
        ...
        400: {
            ...
            "description": (
                ...
                "a source content hash the delivered bytes do not carry. A "
                "relocation moves a document without modifying it, so both "
                "vaults hold the same source at the same digest and each half "
                "checks that against the document in front of it "
                "(CAS-ADR-050). Detail carries `field`, "
