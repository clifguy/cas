    ...
    responses={
        ...
        409: {
            ...
            "description": (
                ...
                "base lifecycle that is every state other than `active`; for "
                "completed, filed, or otherwise non-active predecessors, run "
                "the archive → reactivate dance via "
                "`POST /documents/{id}/lifecycle` before retrying. Detail "
