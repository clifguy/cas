...
Read and follow the complete [canonical review skill](../../../.claude/skills/cas-code-review/SKILL.md) before reviewing.
Resolve that path relative to this file. The canonical skill owns the review procedure and scope.

This entry point follows the canonical skill’s current revision. Its version is maintained there; the Codex skill validator does not accept a top-level `version` field.
