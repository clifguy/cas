...
// Fire-and-forget acknowledgement returned by
// POST /sage_vaults/{vault_id}/documents/{document_id}/reabstract.
// The abstract is regenerated by a background job, not by the call itself;
// poll getDocument until pipeline_status leaves 'abstraction_in_progress' to
// observe the terminal outcome.
export interface ReabstractStartedResponse {
