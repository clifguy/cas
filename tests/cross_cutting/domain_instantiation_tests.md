...
### TEST-DI-SM-001: Example Portfolio vault_config.yaml validates
...
**Artifacts:** `domains/example_vault/agents.yaml`, `domains/example_vault/policies.yaml`
...
**Artifacts:** `domains/example_vault/pipeline.yaml`, `domains/example_vault/agents.yaml`
...
**Artifacts:** `domains/example_vault/workflows.yaml`, `domains/example_vault/agents.yaml`
...
**Artifacts:** `domains/example_vault/pipeline.yaml`, `~/sage_vaults/example_vault/vault_config.yaml`
...
**Artifacts:** `domains/example_vault/policies.yaml`, `~/sage_vaults/example_vault/vault_config.yaml`
...
**Artifacts:** `domains/example_vault/policies.yaml`
